...
contract SimpleAccount is BaseAccount, TokenCallbackHandler, UUPSUpgradeable, Initializable {
    ...
    constructor(IEntryPoint anEntryPoint, address _router, address _link) {
    ...
    /// @dev Combined modifier that checks both chain allowlist and receiver validity
    /// @param _destinationChainSelector The selector of the destination chain
    /// @param _receiver The receiver address
    modifier validateTransferParams(uint64 _destinationChainSelector, address _receiver) {
    ...
    function transferTokensPayLINK(
        ...
        external
        onlyOwner
        validateTransferParams(_destinationChainSelector, _receiver)
